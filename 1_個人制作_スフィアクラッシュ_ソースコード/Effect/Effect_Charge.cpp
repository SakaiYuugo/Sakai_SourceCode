...
//----- 静的変数
ID3D11Buffer* Effect_Charge::m_VertexBuffer{};
ID3D11ShaderResourceView* Effect_Charge::m_Texture{};
bool Effect_Charge::m_Loop;
...
void Effect_Charge::Load()
{
	...
	CreateTextureFromFile(Renderer::GetDevice(),
		"asset/texture/Effect/search.png",
		&m_Texture);
	assert(m_Texture);
