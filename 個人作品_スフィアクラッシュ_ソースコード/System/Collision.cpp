...
void
***************************************************************************/
void Collision::CollisionMath(DirectX::XMFLOAT3 normal, DirectX::XMFLOAT3 Vel_1, DirectX::XMFLOAT3 Vel_2, bool PlayerCollision, int ObjNumber_1, int ObjNumber_2)
{
	float Bounce = 1.0f;
	float Mass_1 = 1.0f;
	float Mass_2 = 1.0f;
...
void
***************************************************************************/
void Collision::SetResultVelocity(DirectX::XMFLOAT3 Vel_1, DirectX::XMFLOAT3 Vel_2, bool PlayerCollision, int ObjNumber_1, int ObjNumber_2)
{
	//----- シーン内のオブジェクトを取得
	Scene* scene = Manager::GetScene();
	std::vector<EnemyBalls*> ballList = scene->GetGameObjects<EnemyBalls>();
...
bool 接地判定
***************************************************************************/
bool Collision::ColliderWithField(DirectX::XMFLOAT3 position, DirectX::XMFLOAT3 scale)
{
