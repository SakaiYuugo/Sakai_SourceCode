...
***************************************************************************/
DirectX::XMFLOAT3 EnemyAttack::EnemyAttackPlayer(float power, DirectX::XMFLOAT3 ThisPos)
{
	//----- プレイヤーの位置を取得
...
DirectX::XMFLOAT3　加速値
***************************************************************************/
DirectX::XMFLOAT3 EnemyAttack::EnemyAttackObject(float power, int ObjNumber, DirectX::XMFLOAT3 ThisPos)
{
	Scene* scene = Manager::GetScene();
