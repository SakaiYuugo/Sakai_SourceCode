...
public:
	...
	//void SetDuble() { dubleFlg = true; }
	void SetCoinCide(ITEM_COINCIDE coincide) { m_CoinCide = coincide; }
	ITEM_COINCIDE GetCoinCide() { return m_CoinCide; }
...
protected:
	...
	static int m_AngleNum;
	//bool dubleFlg = false;
	ITEM_COINCIDE m_CoinCide = ITEM_COINCIDE::ONE;
};
